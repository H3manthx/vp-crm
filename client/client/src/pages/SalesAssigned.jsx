...
// ---- helpers (kept identical to manager view for pixel parity) ----
...
const catLabel = (c) => (c === "pc_component" ? "PC Component" : cap((c || "").replace("_", " ")));

export default function SalesAssigned() {
  ...
  // Prefer detail for richer fields when available
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 pb-24">
      ...
      {/* Header — same aesthetic as manager */}
      ...
      >
        {openLead && (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  className="mt-1 w-full rounded-xl border px-3 py-2 bg-white"
                  readOnly
                  value={catLabel(items?.[0]?.category)}
                />
              </div>
              <div>
            ...
            {/* actions (no transfer; same two buttons) */}

            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  className="mt-1 w-full rounded-xl border px-3 py-2 bg-white"
                  readOnly
                  value={catLabel(openLead.items?.[0]?.category || openLead.category)}
                />
              </div>
              <div>
                ...
                <input
                  className="mt-1 w-full rounded-xl border px-3 py-2 bg-white"
                  readOnly
                  value={openLead.items?.[0]?.brand || openLead.brand || ""}
                />
              </div>
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="mt-1 w-full rounded-xl border px-3 py-2 bg-white"
                  readOnly
                  value={openLead.items?.[0]?.item_description || openLead.product_description || ""}
                />
              </div>
            </div>
